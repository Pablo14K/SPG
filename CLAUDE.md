...
**Las 93 pruebas corren contra `peluqueria_test`**, no contra una base de mentira: es la única
...
**93 pruebas** contra `peluqueria_test`. No prueban PHP: prueban que **las reglas de la base
