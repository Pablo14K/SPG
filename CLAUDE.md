...
>
> **El precio de lista SÍ viaja, como séptimo campo opcional del ITM, y sólo
> para mostrar.** Con los renglones ya netos, del otro lado no quedaba rastro de
> que hubiera existido un descuento: el KuDE imprimía los precios unitarios
> corridos (75.000 como 74.648) y sin nada que lo explicara.
>
> **Va a la columna «%DESC» del renglón, que para eso está** — no a una fila
> nueva en los totales. Con el lista en el campo 7, las tres columnas se explican
> entre sí: **PRECIO UNITARIO** es el de lista, **%DESC** lo que se descontó y el
> importe de la derecha el neto.
>
> | | Antes | Ahora |
> |---|---|---|
> | PRECIO UNITARIO | 74.648 | **75.000** |
> | %DESC | 0 | **1,6** |
> | IMPORTE 10% | 74.648 | 74.648 |
>
> **Y el «DESCUENTO» del pie queda en 0, que es lo correcto**: ése es el
> descuento *global*, y acá se aplicó por renglón. Los importes de la derecha ya
> son netos, así que SUBTOTAL es la suma de los netos y `SUBTOTAL − DESCUENTO =
> TOTAL` **sólo se cumple con esa fila en cero**. La 7.108.0 la puso en el monto
> repartido y con eso el pie dejaba de sumar —159.250 − 750 ≠ 159.250— y encima
> agregó una fila «IMPORTE SIN DESCUENTO» para explicar la diferencia: tapar el
> síntoma con un renglón de más. Se revirtió en la 7.108.1.
>
> **La forma en que se extendió el formato es la parte que importa:**
>
> | | Se declara | Un Automatizador viejo |
> |---|---|---|
> | Campo 5 · precio | **el neto**, como siempre | lo usa igual: el total no cambia |
> | Campo 7 · precio de lista | nada — es para el KuDE | **lo ignora** y se comporta como antes |
>
...
**Las 200 pruebas corren contra `peluqueria_test`**, no contra una base de mentira: es la única
...
**200 pruebas** contra `peluqueria_test`. No prueban PHP: prueban que **las reglas de la base
