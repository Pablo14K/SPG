...
**Las 97 pruebas corren contra `peluqueria_test`**, no contra una base de mentira: es la única
...
**97 pruebas** contra `peluqueria_test`. No prueban PHP: prueban que **las reglas de la base
