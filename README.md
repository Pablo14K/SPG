...
| `docker compose exec app php artisan test` | corre las 50 pruebas |
...
>
> Las **50 pruebas no dependen de esto**: `phpunit.xml` fija `peluqueria_test` por su cuenta,
...
**50 pruebas**, y corren contra `peluqueria_test` — una base de verdad, con el esquema del
