...
| `docker compose exec app php artisan test` | corre las 51 pruebas |
...
>
> Las **51 pruebas no dependen de esto**: `phpunit.xml` fija `peluqueria_test` por su cuenta,
...
**51 pruebas**, y corren contra `peluqueria_test` — una base de verdad, con el esquema del
