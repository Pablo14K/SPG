 ...
 * Se corre con:  php _sim30/estado.php inicial|final
 */
...
$unicos = [
    ...
    'stock_negativo' => 'SELECT COUNT(*) FROM producto WHERE fn_producto_stock(id_producto, 1) < 0',
    'stock_total' => 'SELECT COALESCE(SUM(fn_producto_stock(id_producto, 1)),0) FROM producto',
