...
<div class="row g-3">
    <div class="col-lg-6">
        <div class="sgp-panel h-100">
            <h2 class="sgp-form-titulo mb-2"><i class="bi bi-scissors"></i> Servicios más solicitados</h2>
            @if ($topServicios)
                ...
                @if (count($servicios) > 8)
                    <a class="sgp-graf-mas" href="{{ route('reportes.index', request()->except('r') + ['r' => 'servicios']) }}">
    ...
    <div class="col-lg-6">
        <div class="sgp-panel h-100">
            <h2 class="sgp-form-titulo mb-2"><i class="bi bi-cash-coin"></i> Ingresos por medio de pago</h2>
            @if ($medios)
                ...
                @foreach ($medios as $m)
                    ...
                    <div class="sgp-graf-fila">
                        <span class="sgp-graf-rot" style="width:150px">
                            {{ $m->medio }}
                        ...
                        <span class="sgp-graf-val sgp-graf-val-ancho">{{ money($m->total) }}</span>
                    </div>
                @endforeach
            @else
    ...
    <div class="col-12">
        <div class="sgp-panel">
            <h2 class="sgp-form-titulo mb-2"><i class="bi bi-calendar-week"></i> Demanda por día</h2>
            @include('reportes._barras', [
                'filas' => $demandaDia,
                'max' => $maxDemandaDia,
